...
using QV.Tests.Data.Repository;
using QV.Tests.Data.Domain;
using QV.Data.Specification;
using QV.Tests.Data.Specification;
using QV.Data.EntityFramework;
using System.Data.Objects;

namespace QV.Tests.Data.Repository
{
    [TestFixture]
    public class WithoutStorageTest
    {
        ...
        public void SetUp()
        {
            ObjectContextBuilder<ObjectContext> builder = new ObjectContextBuilder<ObjectContext>("DefaultDb", new[] { "Infrastructure.Tests" }, true, true);
            context = builder.BuildObjectContext();
